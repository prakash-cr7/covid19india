  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: <Widget>[
        ...
        DataTile(
          type: 'Confirmed',
          totalData: Provider.of<Data>(context, listen: true).getDistrictConfirm,
          increaseInData: Provider.of<Data>(context, listen: true).getDeltaDistrictConfirm,
        ...
        DataTile(
          type: 'Recovered',
          totalData: Provider.of<Data>(context, listen: true).getDistrictRecovered,
          increaseInData: Provider.of<Data>(context, listen: true).getDeltaDistrictRecovered,
        ...
        DataTile(
          type: 'Deceased',
          totalData: Provider.of<Data>(context, listen: true).getDistrictDeceased,
          increaseInData: Provider.of<Data>(context, listen: true).getDeltaDistrictDeceased,
        ...
        DataTile(
          type: 'Tested',
          totalData: Provider.of<Data>(context, listen: true).getDistrictTested,
          increaseInData: Provider.of<Data>(context, listen: true).getDeltaDistrictTested,
